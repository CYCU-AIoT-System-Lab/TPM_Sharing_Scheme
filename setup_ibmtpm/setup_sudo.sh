...
setup_ibmacs_env () {
    ...
    if [ $acsMode == 1 ]; then
        ...
        if [ $install_platform -eq 1 ]; then
            ...
            aptins "libjson-c-dev apache2 php php-dev php-mysql mariadb-server libmariadb-dev-dev-compat:amd64 libmariadb-dev:amd64 libmariadb-dev-compat libmariadb-dev libssl-dev"
