...
$dstVM1 = "Ubuntu 64-bit 18.04 Desktop 0x1c"
$dstVM2 = "Ubuntu 64-bit 18.04 Desktop 0x1d"
$dstVM3 = "Ubuntu 64-bit 18.04 Desktop 0x1e"
$dstVM4 = "Ubuntu 64-bit 18.04 Desktop 0x1f"
...
$jobs = "$cp_command `"$baseDir/$srcVM1`" `"$baseDir/$dstVM1`"", 
		...
		"$cp_command `"$baseDir/$srcVM2`" `"$baseDir/$dstVM3`"",
		"$cp_command `"$baseDir/$srcVM2`" `"$baseDir/$dstVM4`""
