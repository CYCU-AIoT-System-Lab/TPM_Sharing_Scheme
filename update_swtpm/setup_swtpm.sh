...
apt_install () {
    echo "$msg1"
    sudo apt install -y $package | ts "$msg" || { echo -e "$msg2"; exit 1; }
}
...
if [ $install_gnutls -eq 1 ]; then
    if [ -d $gnutls_name ]; then echo "$msg4"; else echo "$msg1"
        sudo git clone https://gitlab.com/gnutls/gnutls.git $gnutls_name || { sudo rm -rf $gnutls_name; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
# hg clone
...
if [ $install_gmp -eq 1 ]; then
    if [ -d $gmp_name ]; then echo "$msg4"; else echo "$msg1"
        sudo hg clone https://gmplib.org/repo/gmp-$gmp_version/ $gmp_name || { sudo rm -rf $gmp_name; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
# wget
...
if [ $install_libtpms -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$github/stefanberger/libtpms/archive/refs/tags/v$libtpms_version$libtpms_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_tpm2tss -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$github/tpm2-software/tpm2-tss/releases/download/$tpm2tss_version/tpm2-tss-$tpm2tss_version$tpm2tss_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_jsonc -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$github/json-c/json-c/archive/refs/tags/json-c-$jsonc_version-20230812$jsonc_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_texinfo -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$gnu_mirror/texinfo/texinfo-$texinfo_version$texinfo_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_automake -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$gnu_mirror/automake/automake-$automake_version$automake_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_autoconf -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$gnu_mirror/autoconf/autoconf-$autoconf_version$autoconf_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_help2man -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$gnu_mirror/help2man/help2man-$help2man_version$help2man_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_m4 -eq 1 ]; then
    file="$m4_name$m4_ext"
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$gnu_mirror/m4/m4-$m4_version$m4_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_gperf -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$gnu_mirror/gperf/gperf-$gperf_version$gperf_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_pkgconfig -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "https://pkgconfig.freedesktop.org/releases/pkg-config-$pkgconfig_version$pkgconfig_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_libtool -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$gnu_mirror/libtool/libtool-$libtool_version$libtool_ext" -O $file || { sudo rm -f $file; echo "$msg4"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_libtasn1 -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$gnu_mirror/libtasn1/libtasn1-$libtasn1_version$libtasn1_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_python -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "https://www.python.org/ftp/python/$python_version/Python-$python_version$python_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_libpcre2 -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$github/PCRE2Project/pcre2/releases/download/pcre2-$libpcre2_version/pcre2-$libpcre2_version$libpcre2_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_glib -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$gnome/glib/${glib_version%.*}/glib-$glib_version$glib_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_jsonglib -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$gnome/json-glib/${jsonglib_version%.*}/json-glib-$jsonglib_version$jsonglib_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_bison -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$gnu_mirror/bison/bison-$bison_version$bison_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_openssl -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        ...
        if [[ ${openssl_ver_arr[0]} -ge 3 ]]; then
            sudo wget $wget_flag "$github/openssl/openssl/releases/download/openssl-$openssl_version/openssl-$openssl_version$openssl_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
        else
            sudo wget $wget_flag "https://www.openssl.org/source/old/${openssl_version::-1}/openssl-$openssl_version$openssl_ext" -O $openssl_name$openssl_ext || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
        fi
    fi
else echo "$msg2"; fi
...
if [ $install_libcurl -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "https://curl.se/download/curl-$libcurl_version$libcurl_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_swtpm -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$github/stefanberger/swtpm/archive/refs/tags/v$swtpm_version$swtpm_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_gettext -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$gnu_mirror/gettext/gettext-$gettext_version$gettext_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_flex -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$github/westes/flex/releases/download/v$flex_version/flex-$flex_version$flex_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_utillinux -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$github/util-linux/util-linux/archive/refs/tags/v$utillinux_version$utillinux_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_nettle -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$gnu_mirror/nettle/nettle-$nettle_version$nettle_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_libunistring -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$gnu_mirror/libunistring/libunistring-$libunistring_version$libunistring_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_libev -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$github/mksdev/libev-release/archive/refs/tags/v$libev_version$libev_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_p11kit -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$github/p11-glue/p11-kit/releases/download/$p11kit_version/p11-kit-$p11kit_version$p11kit_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_tcsd -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$sourceforge/trousers/files/trousers/$tcsd_version/trousers-$tcsd_version$tcsd_ext/download" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_tcl -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$sourceforge/tcl/files/Tcl/$tcl_version/tcl$tcl_version-src$tcl_ext/download" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_expect -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$sourceforge/expect/files/Expect/$expect_version/expect$expect_version$expect_ext/download" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_gawk -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$gnu_mirror/gawk/gawk-$gawk_version$gawk_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_socat -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "www.dest-unreach.org/socat/download/socat-$socat_version$socat_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_libseccomp -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$github/seccomp/libseccomp/releases/download/v$libseccomp_version/libseccomp-$libseccomp_version$libseccomp_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_tpm2tools -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$github/tpm2-software/tpm2-tools/releases/download/$tpm2tools_version/tpm2-tools-$tpm2tools_version$tpm2tools_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_tpm2abrmd -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$github/tpm2-software/tpm2-abrmd/releases/download/$tpm2abrmd_version/tpm2-abrmd-$tpm2abrmd_version$tpm2abrmd_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_tpm2tssengine -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$github/tpm2-software/tpm2-tss-engine/releases/download/$tpm2tssengine_version/tpm2-tss-engine-$tpm2tssengine_version$tpm2tssengine_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_libffi -eq 1 ]; then
    ...
    if [ -f $file ]; then echo "$msg4"; else echo "$msg1"
        sudo wget $wget_flag "$github/libffi/libffi/releases/download/v$libffi_version/libffi-$libffi_version$libffi_ext" -O $file || { sudo rm -f $file; echo -e "$msg3"; exit 1; }
    fi
else echo "$msg2"; fi
...
if [ $install_libtpms -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $libtpms_name$libtpms_ext -C $libtpms_name $tar_add_flag
else echo "$msg2"; fi
update_var "$tpm2tss_origin_name"
if [ $install_tpm2tss -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $tpm2tss_name$tpm2tss_ext -C $tpm2tss_name $tar_add_flag
else echo "$msg2"; fi
update_var "$jsonc_origin_name"
if [ $install_jsonc -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $jsonc_name$jsonc_ext -C $jsonc_name $tar_add_flag
else echo "$msg2"; fi
update_var "$texinfo_origin_name"
if [ $install_texinfo -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $texinfo_name$texinfo_ext -C $texinfo_name $tar_add_flag
else echo "$msg2"; fi
update_var "$automake_origin_name"
if [ $install_automake -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $automake_name$automake_ext -C $automake_name $tar_add_flag
else echo "$msg2"; fi
update_var "$autoconf_origin_name"
if [ $install_autoconf -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $autoconf_name$autoconf_ext -C $autoconf_name $tar_add_flag
else echo "$msg2"; fi
update_var "$help2man_origin_name"
if [ $install_help2man -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $help2man_name$help2man_ext -C $help2man_name $tar_add_flag
else echo "$msg2"; fi
update_var "$m4_origin_name"
if [ $install_m4 -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $m4_name$m4_ext -C $m4_name $tar_add_flag
else echo "$msg2"; fi
update_var "$gperf_origin_name"
if [ $install_gperf -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $gperf_name$gperf_ext -C $gperf_name $tar_add_flag
else echo "$msg2"; fi
update_var "$libtool_origin_name"
if [ $install_libtool -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $libtool_name$libtool_ext -C $libtool_name $tar_add_flag
else echo "$msg2"; fi
update_var "$pkgconfig_origin_name"
if [ $install_pkgconfig -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $pkgconfig_name$pkgconfig_ext -C $pkgconfig_name $tar_add_flag
else echo "$msg2"; fi
update_var "$libtasn1_origin_name"
if [ $install_libtasn1 -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $libtasn1_name$libtasn1_ext -C $libtasn1_name $tar_add_flag
else echo "$msg2"; fi
update_var "$python_origin_name"
if [ $install_python -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $python_name$python_ext -C $python_name $tar_add_flag
else echo "$msg2"; fi
update_var "$libpcre2_origin_name"
if [ $install_libpcre2 -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $libpcre2_name$libpcre2_ext -C $libpcre2_name $tar_add_flag
else echo "$msg2"; fi
update_var "$glib_origin_name"
if [ $install_glib -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $glib_name$glib_ext -C $glib_name $tar_add_flag
else echo "$msg2"; fi
update_var "$jsonglib_origin_name"
if [ $install_jsonglib -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $jsonglib_name$jsonglib_ext -C $jsonglib_name $tar_add_flag
else echo "$msg2"; fi
update_var "$bison_origin_name"
if [ $install_bison -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $bison_name$bison_ext -C $bison_name $tar_add_flag
else echo "$msg2"; fi
update_var "$openssl_origin_name"
if [ $install_openssl -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $openssl_name$openssl_ext -C $openssl_name $tar_add_flag
else echo "$msg2"; fi
update_var "$libcurl_origin_name"
if [ $install_libcurl -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $libcurl_name$libcurl_ext -C $libcurl_name $tar_add_flag
else echo "$msg2"; fi
update_var "$swtpm_origin_name"
if [ $install_swtpm -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $swtpm_name$swtpm_ext -C $swtpm_name $tar_add_flag
else echo "$msg2"; fi
update_var "$gettext_origin_name"
if [ $install_gettext -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $gettext_name$gettext_ext -C $gettext_name $tar_add_flag
else echo "$msg2"; fi
update_var "$flex_origin_name"
if [ $install_flex -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $flex_name$flex_ext -C $flex_name $tar_add_flag
else echo "$msg2"; fi
update_var "$utillinux_origin_name"
if [ $install_utillinux -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $utillinux_name$utillinux_ext -C $utillinux_name $tar_add_flag
else echo "$msg2"; fi
update_var "$nettle_origin_name"
if [ $install_nettle -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $nettle_name$nettle_ext -C $nettle_name $tar_add_flag
else echo "$msg2"; fi
update_var "$libunistring_origin_name"
if [ $install_libunistring -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $libunistring_name$libunistring_ext -C $libunistring_name $tar_add_flag
else echo "$msg2"; fi
update_var "$libev_origin_name"
if [ $install_libev -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $libev_name$libev_ext -C $libev_name $tar_add_flag
else echo "$msg2"; fi
update_var "$p11kit_origin_name"
if [ $install_p11kit -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $p11kit_name$p11kit_ext -C $p11kit_name $tar_add_flag
else echo "$msg2"; fi
update_var "$tcsd_origin_name"
if [ $install_tcsd -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $tcsd_name$tcsd_ext -C $tcsd_name $tar_add_flag
else echo "$msg2"; fi
update_var "$tcl_origin_name"
if [ $install_tcl -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $tcl_name$tcl_ext -C $tcl_name $tar_add_flag
else echo "$msg2"; fi
update_var "$expect_origin_name"
if [ $install_expect -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $expect_name$expect_ext -C $expect_name $tar_add_flag
else echo "$msg2"; fi
update_var "$gawk_origin_name"
if [ $install_gawk -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $gawk_name$gawk_ext -C $gawk_name $tar_add_flag
else echo "$msg2"; fi
update_var "$socat_origin_name"
if [ $install_socat -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $socat_name$socat_ext -C $socat_name $tar_add_flag
else echo "$msg2"; fi
update_var "$libseccomp_origin_name"
if [ $install_libseccomp -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $libseccomp_name$libseccomp_ext -C $libseccomp_name $tar_add_flag
else echo "$msg2"; fi
update_var "$tpm2tools_origin_name"
if [ $install_tpm2tools -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $tpm2tools_name$tpm2tools_ext -C $tpm2tools_name $tar_add_flag
else echo "$msg2"; fi
update_var "$tpm2abrmd_origin_name"
if [ $install_tpm2abrmd -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $tpm2abrmd_name$tpm2abrmd_ext -C $tpm2abrmd_name $tar_add_flag
else echo "$msg2"; fi
update_var "$tpm2tssengine_origin_name"
if [ $install_tpm2tssengine -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $tpm2tssengine_name$tpm2tssengine_ext -C $tpm2tssengine_name $tar_add_flag
else echo "$msg2"; fi
update_var "$libffi_origin_name"
if [ $install_libffi -eq 1 ]; then echo "$msg1"
    sudo tar $tar_flag $libffi_name$libffi_ext -C $libffi_name $tar_add_flag
else echo "$msg2"; fi
...
if [ $install_gmp -eq 1 ]; then echo "$msg1"
    sudo ln -sf $gmp_name $gmp_dirname
else echo "$msg2"; fi
update_var "$libtpms_origin_name"
if [ $install_libtpms -eq 1 ]; then echo "$msg1"
    sudo ln -sf $libtpms_name $libtpms_dirname
else echo "$msg2"; fi
update_var "$tpm2tss_origin_name"
if [ $install_tpm2tss -eq 1 ]; then echo "$msg1"
    sudo ln -sf $tpm2tss_name $tpm2tss_dirname
else echo "$msg2"; fi
update_var "$jsonc_origin_name"
if [ $install_jsonc -eq 1 ]; then echo "$msg1"
    sudo ln -sf $jsonc_name $jsonc_dirname
else echo "$msg2"; fi
update_var "$texinfo_origin_name"
if [ $install_texinfo -eq 1 ]; then echo "$msg1"
    sudo ln -sf $texinfo_name $texinfo_dirname
else echo "$msg2"; fi
update_var "$automake_origin_name"
if [ $install_automake -eq 1 ]; then echo "$msg1"
    sudo ln -sf $automake_name $automake_dirname
else echo "$msg2"; fi
update_var "$autoconf_origin_name"
if [ $install_autoconf -eq 1 ]; then echo "$msg1"
    sudo ln -sf $autoconf_name $autoconf_dirname
else echo "$msg2"; fi
update_var "$help2man_origin_name"
if [ $install_help2man -eq 1 ]; then echo "$msg1"
    sudo ln -sf $help2man_name $help2man_dirname
else echo "$msg2"; fi
update_var "$m4_origin_name"
if [ $install_m4 -eq 1 ]; then echo "$msg1"
    sudo ln -sf $m4_name $m4_dirname
else echo "$msg2"; fi
update_var "$gperf_origin_name"
if [ $install_gperf -eq 1 ]; then echo "$msg1"
    sudo ln -sf $gperf_name $gperf_dirname
else echo "$msg2"; fi
update_var "$libtool_origin_name"
if [ $install_libtool -eq 1 ]; then echo "$msg1"
    sudo ln -sf $libtool_name $libtool_dirname
else echo "$msg2"; fi
update_var "$pkgconfig_origin_name"
if [ $install_pkgconfig -eq 1 ]; then echo "$msg1"
    sudo ln -sf $pkgconfig_name $pkgconfig_dirname
else echo "$msg2"; fi
update_var "$libtasn1_origin_name"
if [ $install_libtasn1 -eq 1 ]; then echo "$msg1"
    sudo ln -sf $libtasn1_name $libtasn1_dirname
else echo "$msg2"; fi
update_var "$python_origin_name"
if [ $install_python -eq 1 ]; then echo "$msg1"
    sudo ln -sf $python_name $python_dirname
else echo "$msg2"; fi
update_var "$libpcre2_origin_name"
if [ $install_libpcre2 -eq 1 ]; then echo "$msg1"
    sudo ln -sf $libpcre2_name $libpcre2_dirname
else echo "$msg2"; fi
update_var "$glib_origin_name"
if [ $install_glib -eq 1 ]; then echo "$msg1"
    sudo ln -sf $glib_name $glib_dirname
else echo "$msg2"; fi
update_var "$jsonglib_origin_name"
if [ $install_jsonglib -eq 1 ]; then echo "$msg1"
    sudo ln -sf $jsonglib_name $jsonglib_dirname
else echo "$msg2"; fi
update_var "$bison_origin_name"
if [ $install_bison -eq 1 ]; then echo "$msg1"
    sudo ln -sf $bison_name $bison_dirname
else echo "$msg2"; fi
update_var "$openssl_origin_name"
if [ $install_openssl -eq 1 ]; then echo "$msg1"
    sudo ln -sf $openssl_name $openssl_dirname
else echo "$msg2"; fi
update_var "$libcurl_origin_name"
if [ $install_libcurl -eq 1 ]; then echo "$msg1"
    sudo ln -sf $libcurl_name $libcurl_dirname
else echo "$msg2"; fi
update_var "$swtpm_origin_name"
if [ $install_swtpm -eq 1 ]; then echo "$msg1"
    sudo ln -sf $swtpm_name $swtpm_dirname
else echo "$msg2"; fi
update_var "$gettext_origin_name"
if [ $install_gettext -eq 1 ]; then echo "$msg1"
    sudo ln -sf $gettext_name $gettext_dirname
else echo "$msg2"; fi
update_var "$flex_origin_name"
if [ $install_flex -eq 1 ]; then echo "$msg1"
    sudo ln -sf $flex_name $flex_dirname
else echo "$msg2"; fi
update_var "$utillinux_origin_name"
if [ $install_utillinux -eq 1 ]; then echo "$msg1"
    sudo ln -sf $utillinux_name $utillinux_dirname
else echo "$msg2"; fi
update_var "$nettle_origin_name"
if [ $install_nettle -eq 1 ]; then echo "$msg1"
    sudo ln -sf $nettle_name $nettle_dirname
else echo "$msg2"; fi
update_var "$libunistring_origin_name"
if [ $install_libunistring -eq 1 ]; then echo "$msg1"
    sudo ln -sf $libunistring_name $libunistring_dirname
else echo "$msg2"; fi
update_var "$libev_origin_name"
if [ $install_libev -eq 1 ]; then echo "$msg1"
    sudo ln -sf $libev_name $libev_dirname
else echo "$msg2"; fi
update_var "$p11kit_origin_name"
if [ $install_p11kit -eq 1 ]; then echo "$msg1"
    sudo ln -sf $p11kit_name $p11kit_dirname
else echo "$msg2"; fi
update_var "$tcsd_origin_name"
if [ $install_tcsd -eq 1 ]; then echo "$msg1"
    sudo ln -sf $tcsd_name $tcsd_dirname
else echo "$msg2"; fi
update_var "$tcl_origin_name"
if [ $install_tcl -eq 1 ]; then echo "$msg1"
    sudo ln -sf $tcl_name $tcl_dirname
else echo "$msg2"; fi
update_var "$expect_origin_name"
if [ $install_expect -eq 1 ]; then echo "$msg1"
    sudo ln -sf $expect_name $expect_dirname
else echo "$msg2"; fi
update_var "$gawk_origin_name"
if [ $install_gawk -eq 1 ]; then echo "$msg1"
    sudo ln -sf $gawk_name $gawk_dirname
else echo "$msg2"; fi
update_var "$socat_origin_name"
if [ $install_socat -eq 1 ]; then echo "$msg1"
    sudo ln -sf $socat_name $socat_dirname
else echo "$msg2"; fi
update_var "$libseccomp_origin_name"
if [ $install_libseccomp -eq 1 ]; then echo "$msg1"
    sudo ln -sf $libseccomp_name $libseccomp_dirname
else echo "$msg2"; fi
update_var "$tpm2tools_origin_name"
if [ $install_tpm2tools -eq 1 ]; then echo "$msg1"
    sudo ln -sf $tpm2tools_name $tpm2tools_dirname
else echo "$msg2"; fi
update_var "$tpm2abrmd_origin_name"
if [ $install_tpm2abrmd -eq 1 ]; then echo "$msg1"
    sudo ln -sf $tpm2abrmd_name $tpm2abrmd_dirname
else echo "$msg2"; fi
update_var "$tpm2tssengine_origin_name"
if [ $install_tpm2tssengine -eq 1 ]; then echo "$msg1"
    sudo ln -sf $tpm2tssengine_name $tpm2tssengine_dirname
else echo "$msg2"; fi
update_var "$libffi_origin_name"
if [ $install_libffi -eq 1 ]; then echo "$msg1"
    sudo ln -sf $libffi_name $libffi_dirname
else echo "$msg2"; fi
...
if [ $install_python -eq 1 ]; then echo "$msg1"
    ...
    sudo ldconfig $python_dirname | ts "$msg"
else echo "$msg2"; fi
