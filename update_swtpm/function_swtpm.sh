...
load_preset () {
    ...
    check_var install_pkgconfig 1
    check_var install_libffi 1
    check_var install_bison 1
    check_var install_openssl 1
    check_var install_python 1
    check_var install_pippackage 1
    check_var install_libpcre2 1
    check_var install_glib 1
    check_var install_jsonglib 1
    check_var install_libtasn1 1
    check_var install_help2man 1
    check_var install_autoconf 1
    check_var install_gperf 1
    check_var install_m4 1
    check_var install_automake 1
    check_var install_texinfo 1
    check_var install_libtool 1
    check_var install_gmp 1
    check_var install_jsonc 1
    check_var install_libcurl 1
    check_var install_gettext 1
    check_var install_flex 1
    check_var install_utillinux 1
    check_var install_nettle 1
    check_var install_libunistring 1
    check_var install_libev 1
    check_var install_p11kit 1
    check_var install_gnutls 1
    check_var install_tcsd 1
    check_var install_tcl 1
    check_var install_expect 1
    check_var install_gawk 1
    check_var install_socat 1
    check_var install_libseccomp 1
    check_var install_tpm2tss 1
    check_var install_tpm2tools 1
    check_var install_tpm2abrmd 1
    check_var install_tpm2tssengine 1
    check_var install_libtpms 1
